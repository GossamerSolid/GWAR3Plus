...
class RscListBox
{
	...
	colorSelect[] = {0,0,0,0.3}; // Text selection color
	...
	colorPictureSelected[] = {0,0,0,1}; // Selected picture color
...
class RscMapControl {
	...
	colorText[] = {0.929412, 0.929412, 0.929412, 1.0};
...
class RscProgress
{
	...
	style = 0;
	colorFrame[] = {0,0,0,1};
	colorBar[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.69])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.75])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.5])", "(profilenamespace getvariable ['GUI_BCG_RGB_A',1])"};
